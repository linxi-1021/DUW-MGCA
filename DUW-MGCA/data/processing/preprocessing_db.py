...
def get_inverse_strip_indices(args,h5_entries, strip_value, strip_feature):
    """
...
def strip_feature(args, strip_properties, h5_entries, strip_value, strip_feature, inversion=False):
    ...
    if inversion:
        stripped_indices,  stripped_molecules_begin_atom_index = get_inverse_strip_indices(args,h5_entries, strip_value, strip_feature)
